...
public class EntityDSLParser extends Parser {
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			null, "'entity'", "'{'", "'}'", "':'", "';'", "'primary'", "'generated'", 
			"'required'", "'unique'", "'optional'", "'min'", "'('", "')'", "'max'", 
	...
	public final PropertyContext property() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 446400L) != 0)) {
				{
				{
				setState(32);
				modifier();
	...
	public static class TypeContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof EntityDSLVisitor ) return ((EntityDSLVisitor<? extends T>)visitor).visitType(this);
			else return visitor.visitChildren(this);
		}
	}
